    ...
    <div className="grid md:grid-cols-3 gap-10">
      {items.map((item, i) => {
        ...
        return (
          <div
            key={i}
            className="group text-center p-6 rounded-xl border border-gray-200 bg-white transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
          >
            {/* Icon */}
            ...
            {/* Accent */}
            <div className="mt-4 h-[2px] w-8 bg-yellow-400 mx-auto transition-all duration-300 group-hover:w-12"></div>
          </div>
        );
      })}
    </div>

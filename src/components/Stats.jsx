...
const timeout = setTimeout(() => setStart(true), 1500);
...
return ( <section
 ...
 >
{/* Background glow */} <div className="absolute inset-0 opacity-10 bg-[radial-gradient(circle_at_center,_gold,_transparent_70%)]"></div>
    ...
    {stats.map((stat, index) => (
      ...
      >
        ...
        <h2 className="text-5xl md:text-6xl font-bold text-yellow-400 mb-3 transition-all duration-300 group-hover:drop-shadow-[0_0_12px_gold]">
          {start ? counts[index].toLocaleString() : stat.value}+
        </h2>
